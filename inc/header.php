		...
		<head>
		 ...
		 <style>
		  ...
		  .maincontent{min-height:500px;padding:20px;font-size:18px}
		  p{margin:12}
		 ...
		 .tblone td{padding:10px 10px;text-align:center;}
		 .tblone th{padding:10px 10px;text-align:center;}
		...
		<div class="phpcoding">
		 <section class="headeroption">
		  <h2><?php echo "Vehicle Booking Service"; ?></h2>
		 </section>
